...
<Section name = {""} , imageLocation = "/dining/j.png" about =  {"Devigarh offers a range of local and international cuisine to suit all tastes, and in a range of settings that show off the hidden jewels of the palace. Breakfast and Dinner are served in our restaurant, whilst Lunch can be enjoyed in the Bar"}/>
</div>
